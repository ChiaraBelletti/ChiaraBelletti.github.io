...
Research interests
----- 
Digital Marketing, Quantitative Marketing, Applied Economics, Digital Economics, Economics of Information Systems, Industrial Organization, Platform Strategy.

Working Papers
----- 

* <a href="https://www.cesifo.org/en/publications/2024/working-paper/rating-systems-and-end-game-effect-when-reputation-works-and-when">"Rating Systems and the End-Game Effect: When Reputation Works and When it Doesn't"</a>, with Elizaveta Pronkina (Amazon) and Michelangelo Rossi (HEC Paris), 2025.
...
* "Visual Clutter and Marketing Cues: Experimental Evidence from the OTA industry", with Damien Mayaux (Université Paris Dauphine - PSL), Bruno Chaves Ferreira (CNRS, Université Paris Dauphine - PSL) and Calvin Pan (University of Virginia).
